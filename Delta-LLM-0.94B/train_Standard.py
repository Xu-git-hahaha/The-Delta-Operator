...
from Standard import StandardTransformer1BModel, StandardConfig
...
OUTPUT_DIR = "checkpoints_standard-1B"
...
def train():
    ...
    print("🏗️ Initializing Standard Transformer (Baseline) Model...")
    ...
    model = StandardTransformer1BModel(config)
    ...
    print(f"🔥 Starting Training with Standard AdamW (Baseline)!")
